...
const typeConfig = {
  ...
  doc_resubmitted: { icon: <ShieldCheck size={18} />, color: 'bg-orange-50 text-orange-500' },
  engagement_proposed: { icon: <Calendar size={18} />, color: 'bg-primary-50 text-primary' },
  engagement_request: { icon: <Calendar size={18} />, color: 'bg-secondary-50 text-secondary' },
  tutor_interest: { icon: <Star size={18} />, color: 'bg-accent-50 text-accent' },
